...
<header>
    <nav>
      ...
      <div class="logo">
      <a href="index.php">Warkop <span style="color: green;">Yor</span></a>
      </div>
    </nav>
  </header>
    ...
    <section class="detail">
        <div class="detailproduct">
          ...
          <div class="hero3content">
            <h2>Cappuccino (25K)</h2>
            <p>Barista Warkop Yor menghadirkan sebuah racikan kopi di blend dengan susu yang sudah di steam hingga mengental.</p>
